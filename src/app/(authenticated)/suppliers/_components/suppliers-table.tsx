...
export function SuppliersTable({ data }: DataTableProps) {
  ...
  return (
    ...
    >
      <DataTableToolbar
        table={table}
        searchPlaceholder="Buscar por NIT, nombre o teléfono..."
        filters={[
          {
            columnId: "activo",
            title: "Estado",

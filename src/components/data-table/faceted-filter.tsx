...
export function DataTableFacetedFilter<TData, TValue>({
  ...
  const selectedValues = new Set(
    currentFilterValues.map((v) => (typeof v === "boolean" ? v.toString() : v))
  );
                ...
                return (
                  <CommandItem
                    ...
                    onSelect={() => {
                      ...
                      // Convertir de vuelta a los tipos originales para el filtro
                      const filterValues = Array.from(selectedValues).map(
